...
class SLRModel(nn.Module):
    def __init__(
        ...
        self.conv1d = TemporalConv(
            input_size=512,  # 512 resnet18, 512 resnet34, 1280 mobilenet v2, 512 squeezenet1_1, 1024 shufflenet_v2_x1_0, 1280 efficientnet_b1, 1280 mnasnet1_0, 784 regnet_y_800mf, 672 regnet_x_800mf, 400 regnet_x_400mf, 4096 vgg16_bn, 888 regnet_y_1_6gf, 2048 resnet50, 576 mobilenet_v3_small, 1024 shufflenet_v2_x0_5
